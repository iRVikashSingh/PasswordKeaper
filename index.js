function handleFormSubmit(event) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/54dc2015e3764b6fb10e9c780cad3316/newPassword",
      userDetails
    )
    .then((response) => {
...
function deleteUserFromApi(userDetails) {
  axios
    .delete(
      `https://crudcrud.com/api/54dc2015e3764b6fb10e9c780cad3316/newPassword/${userDetails._id}`
    )
    .then((response) => {
